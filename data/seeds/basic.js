...
function genEvent() {
  ...
  if (showData) {
    console.log(`Totals--> \nUser Credentials:${Math.ceil(safeTotalUsers)}\nUser Data:${Math.ceil(safeTotalUsers)}\nClasses:${Math.ceil(classes)}\nEvent:${Math.ceil(totalEvents)}\nChuck Size:${chunkSize}\nLimit:${limit}\nTotal Users${totalUsers}\nTotal Rows:${safeTotalUsers+safeTotalUsers+classes+totalEvents}`);
  } else {
    console.log(`Totals--> User Credentials:${Math.ceil(safeTotalUsers)} | User Data:${Math.ceil(safeTotalUsers)} | Classes:${Math.ceil(classes)} | Event:${Math.ceil(totalEvents)} | Total Rows:${safeTotalUsers+safeTotalUsers+classes+totalEvents}`);
  }
  return fakeEvents
}
